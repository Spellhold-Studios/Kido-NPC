...
IF ~Global("finalconKaAn25","GLOBAL",1)~ THEN BEGIN lastquabAnjo25
 SAY @136 
  ...
  IF ~~ THEN REPLY @140 DO ~SetGlobal("finalconKaAn25","GLOBAL",2)~ EXTERN KIDOP25 0
...
IF ~InParty(Player1)
  ...
  SAY @144
  IF ~~ THEN REPLY @145 EXTERN GORMAD 16
  IF ~~ THEN REPLY @146 EXTERN GORMAD 16
  IF ~~ THEN REPLY @147 EXTERN GORMAD 17
END
